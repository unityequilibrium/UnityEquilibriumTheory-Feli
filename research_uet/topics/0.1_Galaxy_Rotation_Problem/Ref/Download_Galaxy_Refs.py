"""
UET Galaxy Rotation Reference Downloader
========================================
Searches arXiv for seminal papers on:
- SPARC Dataset (Lelli et al.)
- Radial Acceleration Relation (McGaugh)
- MOND (Milgrom)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "ti:SPARC mass models disk galaxies",
    "ti:Radial acceleration relation rotationally supported",
    "all:Renzo's rule galaxy rotation",
    "all:Milgrom MOND modification Newtonian",
]
...
def main():
    print("📚 UET Galaxy Reference Downloader")
    print("==================================")
