"""
UET AI & Alignment Reference Downloader
=======================================
Searches arXiv for seminal papers on:
- Transformer Architecture (Vaswani et al.)
- Neural Scaling Laws (OpenAI/Kaplan)
- AI Safety & Alignment (Anthropic/Amodei)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "all:Attention Is All You Need Vaswani transformer",
    "all:Scaling Laws for Neural Language Models Kaplan OpenAI",
    "all:Concrete Problems in AI Safety Amodei safety",
    "all:Constitutional AI alignment Anthropic",
    "all:AI safety alignment review paper",
]
...
def main():
    print("📚 UET AI Reference Downloader")
    print("==============================")
