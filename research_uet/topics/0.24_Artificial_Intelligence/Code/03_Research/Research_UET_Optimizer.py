"""
Research: UET Optimizer Benchmark
=================================
Comparing Standard Gradient Descent vs UET Thermodynamic Optimization.
"""
...
def run_benchmark():
    ...
    print(
        f"{'Step':<5} | {'STD Loss':<10} {'STD Ratio':<10} | {'UET Loss':<10} {'UET Ratio':<10}"
    )
    print("-" * 60)
