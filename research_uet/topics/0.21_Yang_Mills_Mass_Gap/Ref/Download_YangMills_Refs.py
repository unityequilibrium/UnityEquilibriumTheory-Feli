"""
UET Yang-Mills Reference Downloader
===================================
Searches arXiv for seminal papers on:
- 1954 Yang-Mills Gauge Theory
- Millennium Prize Mass Gap Problem
- Renormalizability of Gauge Fields
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "all:Yang-Mills Conservation Isotopic Spin Isotopic Gauge Invariance",
    "all:Yang-Mills existence and mass gap millennium prize",
    "all:Witten Jaffe Quantum Yang-Mills Theory",
    "all:t Hooft Veltman Regularization and renormalization of gauge fields",
    "all:Lattice QCD Glueball mass gap spectrum",
]
...
def main():
    print("📚 UET Yang-Mills Reference Downloader")
    print("======================================")
