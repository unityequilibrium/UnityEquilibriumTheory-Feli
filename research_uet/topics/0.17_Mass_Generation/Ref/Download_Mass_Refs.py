"""
UET Mass Generation Reference Downloader
========================================
Searches arXiv for seminal papers on:
- Higgs Mechanism (Higgs, Englert-Brout)
- Yang-Mills Mass Gap (Millennium Prize)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "all:Broken Symmetries and the Masses of Gauge Bosons Higgs",
    "all:Broken Symmetry and the Mass of Gauge Vector Mesons Englert",
    "all:Quantum Yang-Mills theory mass gap witten",
    "all:Global Conservation Laws and Massless Particles Guralnik",
    "all:Mass generation mechanism review particle physics",
]
...
def main():
    print("📚 UET Mass Generation Reference Downloader")
    print("===========================================")
