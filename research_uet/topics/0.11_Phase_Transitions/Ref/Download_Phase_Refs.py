"""
UET Phase Transitions Reference Downloader
==========================================
Searches arXiv for seminal papers on:
- 20D Ising Model (historical context)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "all:Onsager Ising model crystal statistics",
    "all:Kenneth Wilson renormalization group critical phenomena",
    "all:Higgs broken symmetries masses gauge bosons",
    "all:Kadanoff scaling picture renormalization",
]
...
def search_arxiv(query, max_results=3):
    """Search arXiv API."""
    # Note: ArXiv mostly has modern papers. For older papers, we'll find modern commentaries/reprints.
...
def main():
    print("📚 UET Phase Transitions Reference Downloader")
    print("=============================================")
