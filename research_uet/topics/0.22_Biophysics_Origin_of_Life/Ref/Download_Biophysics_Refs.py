"""
UET Biophysics Reference Downloader
=======================================
Searches arXiv and BioRxiv for seminal papers on:
- Dissipative Adaptation (Jeremy England)
- Free Energy Principle (Karl Friston)
- Biological Entropy (Cancer/Seizure)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "ti:dissipative adaptation AND au:England",
    "ti:free energy principle AND au:Friston",
    "all:Nick Lane William Martin origin of life",
    "all:Stuart Kauffman autocatalytic sets",
    "all:Schrodinger What is Life physics",
    "all:entropy cancer network",
]
...
def main():
    print("📚 UET Reference Downloader (Open Access)")
    print("========================================")
