"""
UET Neutrino Reference Downloader
=================================
Searches arXiv for seminal papers on:
- Solar Neutrinos (Ray Davis)
- Neutrino Oscillations (Pontecorvo)
- Atmospheric Neutrino Evidence (Super-Kamiokande)
- Neutrino Mass Limits (KATRIN)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "ti:Search for neutrinos from the Sun",
    "all:Neutrino Experiments and the Problem of Conservation of Leptonic Charge",
    "ti:Evidence for Oscillation of Atmospheric Neutrinos",
    "all:KATRIN neutrino mass limit nature physics",
]
...
def main():
    print("📚 UET Neutrino Reference Downloader")
    print("====================================")
