"""
UET Unity Scale Link Reference Downloader
==========================================
Searches arXiv for seminal papers on:
- Renormalization Group (Kenneth Wilson)
- Fractals and Self-Similarity (Benoit Mandelbrot)
- Universal Scaling Laws (Geoffrey West)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "all:Kenneth Wilson renormalization group critical phenomena",
    "all:Mandelbrot self-similarity fractional dimension",
    "all:Geoffrey West allometric scaling laws biology physics",
    "all:Scale invariance unified field theory review",
    "all:hierarchical systems complexity science",
]
...
def main():
    print("📚 UET Unity Scale Link Reference Downloader")
    print("============================================")
