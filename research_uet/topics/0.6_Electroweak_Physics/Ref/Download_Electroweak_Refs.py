"""
UET Electroweak Reference Downloader
====================================
Searches arXiv for seminal papers on:
- Weinberg's Model of Leptons
- Parity Violation (Wu Experiment)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "ti:Model of Leptons Weinberg",
    "all:Parity Violation Wu Experiment 1957",
    "all:KATRIN direct neutrino mass measurement",
    "all:Electroweak symmetry breaking Higgs",
]
...
def main():
    print("📚 UET Electroweak Reference Downloader")
    print("=======================================")
