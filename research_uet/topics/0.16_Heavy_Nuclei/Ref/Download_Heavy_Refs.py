"""
UET Heavy Nuclei Reference Downloader
=====================================
Searches arXiv for seminal papers on:
- Superheavy Elements (Oganessian/GSI)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "all:Oganessian superheavy element research island of stability",
    "all:Maria Goeppert Mayer nuclear shell model magic numbers",
    "all:George Gamow alpha decay quantum theory",
    "all:GSI Darmstadt heavy element synthesis SHIP",
    "all:Island of stability nuclear physics review",
]
...
def main():
    print("📚 UET Heavy Nuclei Reference Downloader")
    print("========================================")
