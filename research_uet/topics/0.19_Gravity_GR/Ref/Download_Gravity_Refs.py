"""
UET Gravity Reference Downloader
================================
Searches arXiv for seminal papers on:
- General Relativity (Einstein context)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "all:Einstein General Relativity 1915 history",
    "all:Observation of Gravitational Waves from a Binary Black Hole Merger LIGO",
    "all:Schwarzschild solution black hole singularity history",
    "all:Einstein-Hilbert action derivation unified field",
    "all:Modified Gravity Review MOND TeVeS",
]
...
def main():
    print("📚 UET Gravity Reference Downloader")
    print("===================================")
