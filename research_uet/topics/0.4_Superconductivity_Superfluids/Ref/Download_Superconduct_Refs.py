...
# --- CONFIG ---
SEARCH_QUERIES = [
    "ti:Theory of Superconductivity Bardeen Cooper Schrieffer",
    "all:Ginzburg Landau superconductivity phase transition",
    "all:Landau superfluid helium theory",
    "all:high temperature superconductivity cuprates",
]
...
def main():
    print("📚 UET Superconductivity Reference Downloader")
    print("=============================================")
