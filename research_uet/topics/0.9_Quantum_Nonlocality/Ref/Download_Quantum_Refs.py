"""
UET Quantum Nonlocality Reference Downloader
============================================
Searches arXiv for seminal papers on:
- Einstein-Podolsky-Rosen Paradox (EPR)
- Bell's Theorem
- Experimental Bell Tests (Aspect)
- Loophole-free Bell tests (Hensen)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "all:Einstein Podolsky Rosen paradox incomplete description",
    "all:John Bell On the Einstein Podolsky Rosen paradox",
    "all:Alain Aspect experimental test Bell inequalities",
    "all:Loophole-free Bell inequality violation nature 2015",
]
...
def main():
    print("📚 UET Quantum Reference Downloader")
    print("===================================")
