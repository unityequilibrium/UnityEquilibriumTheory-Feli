"""
UET Thermodynamic Reference Downloader
======================================
Searches arXiv for seminal papers on:
- Statistical Mechanics (Boltzmann/Entrophy)
- Information Thermodynamics (Landauer)
- Communication Theory (Shannon context)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "all:Ludwig Boltzmann entropy probability",
    "all:Landauer's principle information thermodynamics",
    "all:Shannon information theory entropy",
    "all:Second law of thermodynamics Clausius entropy",
]
...
def main():
    print("📚 UET Thermodynamic Reference Downloader")
    print("=========================================")
