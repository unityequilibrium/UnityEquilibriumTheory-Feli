"""
UET Cosmology Reference Downloader
==================================
Searches arXiv for seminal papers on:
- Planck 2018 Results (CMB)
- SH0ES Project (Riess et al.)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "ti:Planck 2018 results VI Cosmological parameters",
    "ti:Comprehensive Measurement Local Hubble Constant",
    "all:Hubble Tension Cosmology",
    "all:Baryon Oscillation Spectroscopic Survey BOSS",
]
...
def main():
    print("📚 UET Cosmology Reference Downloader")
    print("=====================================")
