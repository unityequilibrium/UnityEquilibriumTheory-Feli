"""
UET Muon g-2 Reference Downloader
=================================
Searches arXiv for seminal papers on:
- 2021 Fermilab Muon g-2 Result
- 2006 Brookhaven E821 Result
- 2020 Muon g-2 Theory Initiative White Paper
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "ti:Measurement of the anomalous precession frequency of the muon",
    "ti:Final Report of the Muon E821 Anomalous Magnetic Moment",
    "ti:anomalous magnetic moment of the muon in the Standard Model",
    "all:Muon g-2 experiment Fermilab 2021",
]
...
def main():
    print("📚 UET Muon g-2 Reference Downloader")
    print("====================================")
