"""
UET Nuclear Physics Reference Downloader
========================================
Searches arXiv for seminal papers on:
- Lattice QCD Confinement (Wilson)
- Atomic Mass Evaluation (AME2020 context)
- Meson Theory
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "ti:Confinement of quarks",
    "all:Atomic Mass Evaluation AME2020",
    "all:Yukawa meson theory interaction elementary particles",
    "all:Lattice QCD Wilson loop",
]
...
def main():
    print("📚 UET Nuclear Reference Downloader")
    print("===================================")
