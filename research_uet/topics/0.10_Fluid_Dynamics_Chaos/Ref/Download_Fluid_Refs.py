"""
UET Fluid Dynamics Reference Downloader
=======================================
Searches arXiv for seminal papers on:
- Navier-Stokes derivations (history/modern)
- Kolmogorov Turbulence Theory (K41)
- Lorenz Chaos and Butterfly Effect
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "all:Navier Stokes equations history derivation",
    "ti:local structure of turbulence Kolmogorov",
    "all:Edward Lorenz deterministic nonperiodic flow chaos",
    "all:Three-body problem chaos physics",
]
...
def main():
    print("📚 UET Fluid Reference Downloader")
    print("=================================")
