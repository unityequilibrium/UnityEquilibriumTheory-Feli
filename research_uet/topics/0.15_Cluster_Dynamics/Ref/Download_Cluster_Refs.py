"""
UET Cluster Dynamics Reference Downloader
=========================================
Searches arXiv for seminal papers on:
- 1933 Zwicky Coma Cluster (historical context)
- 2006 Bullet Cluster (Clowe et al.)
- Galaxy Cluster Surveys (SDSS/Bahcall)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "all:Direct Empirical Proof Existence Dark Matter Bullet Cluster",
    "all:Zwicky Die Rotverschiebung extragalaktischen Nebeln",
    "ti:Large-Scale Structure Universe Galaxy Clusters Bahcall",
    "all:Modified Gravity Galaxy Clusters Dark Matter Alternative",
]
...
def main():
    print("📚 UET Cluster Reference Downloader")
    print("===================================")
