"""
UET Black Hole Reference Downloader
===================================
Searches arXiv for seminal papers on:
- Thermodynamics of Spacetime (Jacobson)
- Cosmological Coupling of Black Holes (Farrah)
- EHT Results (Shadow)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "ti:Thermodynamics of Spacetime Einstein equation",
    "ti:Observational Evidence Cosmological Coupling Black Holes",
    "all:Event Horizon Telescope M87 shadow",
    "all:black hole entropy Bekenstein",
]
...
def main():
    print("📚 UET Black Hole Reference Downloader")
    print("======================================")
