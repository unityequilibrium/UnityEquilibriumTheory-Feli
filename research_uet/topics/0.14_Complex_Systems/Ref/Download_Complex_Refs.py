"""
UET Complex Systems Reference Downloader
========================================
Searches arXiv for seminal papers on:
- Emergence (P.W. Anderson)
...
# --- CONFIG ---
SEARCH_QUERIES = [
    "all:P.W. Anderson More is different science 1972",
    "all:Albert-Laszlo Barabasi Emergence of Scaling in Random Networks",
    "all:Ilya Prigogine Self-Organization in Non-Equilibrium Systems",
    "all:Granger Causality Econometrica 1969",
    "all:Complex adaptive systems physics Review",
]
...
def main():
    print("📚 UET Complex Systems Reference Downloader")
    print("===========================================")
